...
export function LandingPage({ onNavigate }: LandingPageProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100">
      {/* Header with Login - This will be the single taskbar */}
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-6xl font-bold mb-6 bg-gradient-to-r from-orange-600 via-orange-700 to-orange-800 bg-clip-text text-transparent leading-tight">
            Foundry
          </h1>
          <p className="text-4xl text-black mb-4 font-bold">
            Drag. Drop. Deploy.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center p-6 rounded-2xl bg-white/60 backdrop-blur-sm border border-orange-200/30 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Deploy AWS infrastructure in minutes, not hours. Our visual
              interface streamlines the entire process.
            </p>
          </div>
          ...
          <div className="text-center p-6 rounded-2xl bg-white/60 backdrop-blur-sm border border-orange-200/30 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Built-in security best practices and automated compliance checks
              ensure your infrastructure stays protected.
            </p>
          </div>
          ...
          <div className="text-center p-6 rounded-2xl bg-white/60 backdrop-blur-sm border border-orange-200/30 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              From prototype to production, scale your applications across AWS
              regions with just a few clicks.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-orange-100 text-lg mb-8 max-w-2xl mx-auto">
            ...
            cloud infrastructure with Foundry.
          </p>
          <Button
            onClick={() => onNavigate("workflows")}
            size="lg"
