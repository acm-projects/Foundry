...
export function SettingsDialog({
  ...
  const handleDeleteWorkflow = () => {
    if (onDeleteWorkflow && workflowId) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Manage sharing permissions and workflow settings. Invite team
            members or delete this workflow.
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="space-y-4">
                <div className="p-4 border border-destructive/20 rounded-lg bg-destructive/5">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Once you delete this workflow, there is no going back. This
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          delete the workflow "{workflowName}" and remove all
                          associated data.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
