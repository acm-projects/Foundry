...
interface ActivityLog {
  ...
  action: 'created' | 'edited' | 'deleted' | 'configured' | 'saved' | 'shared' | 'viewed' | 'deployed';
  target: string;
  details: string;
  workflowName?: string;
  metadata?: {
                        ...
                        <div className="mt-3 p-3 bg-muted rounded-lg">
                          ...
                          {log.metadata.serviceName && (
                            <div className="text-sm text-muted-foreground">
                              Service: <code className="bg-muted px-1 rounded text-xs">{log.metadata.serviceName}</code>
                            </div>
                          )}
                        </div>
                      )}
