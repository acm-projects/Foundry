...
function UpdateModal({ isOpen, onClose, stackName, keyPairs }) {
    ...
    // Reset state when modal opens for new update
    useEffect(() => {
        if (isOpen) {
            setResources([]);
            setLogs([]);
            ...
            setLastValidProgress({ completed: 0, total: 0, percentage: 0 });
        }
    }, [isOpen]);
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full h-full max-w-7xl max-h-[90vh] flex flex-col animate-in fade-in zoom-in duration-200">
                ...
                <div className="px-6 py-4 border-b border-gray-200 flex-shrink-0">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            >
                                {isFailed ? "Failed" : isComplete ? "Complete" : "Updating"}
                            </span>
                            <button
                                onClick={onClose}
                ...
                >
                        ...
                        >
                            {logs.length === 0 ? (
                                <div className="text-center py-8 text-gray-500">
                                    ...
                                    <p className="text-sm">Initializing update...</p>
                                </div>
                            ) : (
                    ...
                    <div
                        ...
                        className={`w-1 bg-gray-300 hover:bg-orange-500 cursor-col-resize transition-colors relative group ${isDragging ? "bg-orange-500" : ""}`}
