...
import { Server,Database,Archive,Cloud,Github,MousePointer2 } from 'lucide-react';
...
export default function SideBar2 ()  {
  ...
  <Cloud className="w-8 h-8" />
    ...
    <div className = "pb-6">
      <div className="dndnode flex items-center justify-center bg-white p-4 bg-whiterounded shadow"
        onDragStart={(event) => onDragStart(event, "github")}
        draggable>
        <Github/>
</div>
    </div>
    ...
    <div className = "pb-6">
      <div className="dndnode flex items-center justify-center p-4 bg-white  rounded shadow"
    ...
    <div className = "pb-6">
      <div className="dndnode flex items-center justify-center p-4 bg-white  rounded shadow"
        onDragStart={(event) => onDragStart(event, "deploy")}
        draggable>
       <MousePointer2/>
</div>
    </div>
    <div className = "pb-6">
      <div className="dndnode flex items-center justify-center p-4 bg-white  rounded shadow"
        onDragStart={(event) => onDragStart(event, "live")}
        draggable>
       <MousePointer2/>
</div>
    </div>
