...
{live ? <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-green-100 text-green-800 border border-green-200 shadow-md font-semibold text-sm cursor-default">
