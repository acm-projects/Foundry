...
export default function S3Log() { 
    ...
    <div className="flex items-start gap-3 w-7/8">
      ...
      <div className="w-7/8">
        ...
        <h1 className = "text-gray-700">how many objects an S3 bucket contains and how much total storage space they occupy.</h1>
      <input className = "mt-4" placeholder = "bucket name"/> 
    <div className="rounded-xl bg-gray-100 mt-3  flex justify-between items-start gap-6">
      <div className="flex-1">
        ...
        <div className="list-disc space-y-1 text-gray-700">
          ...
          <p>Average - 5,000,000,000<span> bytes</span></p>
          <p>Files stored - <span>12,0045</span></p>
        </div>
      </div>
